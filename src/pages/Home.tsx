...
export function Home() {
    ...
    return (
        <div className="flex-1 flex flex-col w-full overflow-x-hidden bg-[#050505]">
            {/* Hero Section */}
            <section className="relative pt-40 pb-24 lg:pt-56 lg:pb-32 px-6 lg:px-20 overflow-hidden flex flex-col items-center justify-center min-h-[85vh]">
                ...
                <div className="max-w-5xl mx-auto text-center relative z-10 w-full flex flex-col items-center">
                    ...
                    <Reveal delay={0.1} amount={0.05}>
                        <h1 className="text-5xl md:text-7xl lg:text-[7.5rem] font-extrabold text-transparent bg-clip-text bg-gradient-to-b from-white via-white/90 to-white/40 mb-6 tracking-tight leading-[1.1]">
                            Tactical<br />Mesh
                        </h1>
                    </Reveal>
